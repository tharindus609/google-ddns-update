...
while True:
    ...
    print("querying current DDNS IP: {0}".format(g_domain))
    ...
    try:
        ...
        if len(sock_host[2]) == 1:
            ...
            print("current DDNS IP: {0}".format(current_ddns_ip))
        else:
    ...
    if gapi_response.status_code == 200:
        if current_ddns_ip != gapi_response.text:
            ...
            print('updating new DDNS IP: {0}'.format(current_ddns_ip))
        else:
            DDNS_UPDATE_REQUIRED = False
    ...
    if DDNS_UPDATE_REQUIRED:
        ...
        if gapi_response.status_code == 200:
            ...
            print("Not OK response recived: {0}".format(gapi_response.text))
